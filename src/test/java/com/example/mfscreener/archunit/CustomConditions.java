...
public class CustomConditions {
    ...
    private static final String GETTER_OR_SETTER_NOT_PRESENT_ERROR_MESSAGE =
            "Field %s of %s does not have %s";
    ...
    private static final String EQUALS_OR_HASH_CODE_NOT_PRESENT_ERROR_MESSAGE =
            "%s not found in %s";
    private static final String EQUALS_METHOD = "equals";
    private static final String HASH_CODE_METHOD = "hashCode";

    public static final ArchCondition<JavaClass> HAVE_EQUALS_AND_HASH_CODE =
            buildClassHaveEqualsAndHashCodeCondition();
    public static final ArchCondition<JavaClass> HAVE_NOT_STATIC_METHODS =
            buildStaticMethodsAreNotAllowedCondition();
        ...
        return new ArchCondition<JavaField>(
            ...
            public void check(JavaField field, ConditionEvents events) {
                Set<String> publicMethods =
                        field.getOwner().getMethods().stream()
                ...
                String getter =
                        calculateGetterPrefix(field.reflect().getType().getName())
                                + capitalize(name);
    ...
    private static ArchCondition<JavaClass> buildClassHaveEqualsAndHashCodeCondition() {
        return new ArchCondition<JavaClass>(EQUALS_AND_HASH_CODE_DESCRIPTION) {
            ...
            public void check(JavaClass javaClass, ConditionEvents events) {
                Optional<JavaMethod> equalsMethod =
                        findPublicMethodFromClass(javaClass, EQUALS_METHOD);
                Optional<JavaMethod> hashCodeMethod =
                        findPublicMethodFromClass(javaClass, HASH_CODE_METHOD);
    ...
    private static Optional<JavaMethod> findPublicMethodFromClass(
