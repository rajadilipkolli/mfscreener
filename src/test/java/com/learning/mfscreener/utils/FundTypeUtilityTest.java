...
class FundTypeUtilityTest {
    ...
    void shouldReturnUnknownWhenNoRedemptionTransactions() {
        ...
        transactions.add(createTransaction(TransactionType.PURCHASE, BigDecimal.valueOf(100.0)));
        transactions.add(createTransaction(TransactionType.PURCHASE_SIP, BigDecimal.valueOf(50.0)));
    ...
    void shouldReturnUnknownWhenOnlyReversalTransactionsWithNegativeUnits() {
        ...
        transactions.add(createTransaction(TransactionType.REVERSAL, BigDecimal.valueOf(-50.0)));
        transactions.add(createTransaction(TransactionType.PURCHASE, BigDecimal.valueOf(100.0)));
    ...
    void shouldReturnEquityWhenSTTTaxTransactionPresent() {
        ...
        transactions.add(createTransaction(TransactionType.REDEMPTION, BigDecimal.valueOf(-50.0)));
    ...
    void shouldReturnEquityWhenSTTTaxTransactionPresentWithSwitchOut() {
        ...
        transactions.add(createTransaction(TransactionType.SWITCH_OUT, BigDecimal.valueOf(-30.0)));
    ...
    void shouldReturnDebtWhenNoSTTTaxButHasSwitchOutTransactions() {
        ...
        // Add switch out transaction (negative units)
        transactions.add(createTransaction(TransactionType.SWITCH_OUT, BigDecimal.valueOf(-25.0)));
    ...
    void shouldReturnEquityWithMultipleTransactionTypesWhenSTTTaxPresent() {
        ...
        transactions.add(createTransaction(TransactionType.PURCHASE, BigDecimal.valueOf(100.0)));
        transactions.add(createTransaction(TransactionType.PURCHASE_SIP, BigDecimal.valueOf(50.0)));
        transactions.add(createTransaction(TransactionType.SWITCH_IN, BigDecimal.valueOf(25.0)));
        transactions.add(createTransaction(TransactionType.REDEMPTION, BigDecimal.valueOf(-30.0)));
        transactions.add(createTransaction(TransactionType.SWITCH_OUT, BigDecimal.valueOf(-20.0)));
    ...
    private UserTransactionDTO createTransaction(TransactionType type, BigDecimal units) {
