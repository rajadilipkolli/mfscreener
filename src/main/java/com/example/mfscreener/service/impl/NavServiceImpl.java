...
public class NavServiceImpl implements NavService {
    ...
    Function<NAVData, MFSchemeNav> navDataToMFSchemeNavFunction = navData -> {
    ...
    public void fetchSchemeDetails(Long schemeCode) {
        ...
        if (navResponseResponseEntity.getStatusCode().is2xxSuccessful()) {
            ...
            MFScheme mfScheme = mfSchemesRepository.findBySchemeId(schemeCode).orElseThrow(() -> new SchemeNotFoundException("Fund with schemeCode "+ schemeCode + " Not Found"));
